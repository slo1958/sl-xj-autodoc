...
#tag Events btn_find_folder
	#tag Event
		Sub Pressed()
		  ...
		  dlg.PromptText = "Please select the folder containing the project"
		  dlg.InitialFolder = SpecialFolder.Documents
		  
		  var fld as FolderItem =  dlg.ShowModal
		  if fld = nil then Return
		  
		  TextField1.text = fld.NativePath
...
#tag Events TextField1
	#tag Event
		Sub Opening()
		  ...
		  me.text = "/Volumes/LaCie/kverzu-projects/sl-xj-autodoc/html-version"
...
#tag Events btn_analyze_project
	#tag Event
		Sub Pressed()
		  ...
		  if not fld.IsFolder then return
